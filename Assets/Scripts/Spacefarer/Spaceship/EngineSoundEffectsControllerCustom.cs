...
namespace VSX.UniversalVehicleCombat.Space
{
    ...
    /// </summary>
    public class EngineSoundEffectsControllerCustom : MonoBehaviour
    {
        ...
        [SerializeField]
        protected AudioSource spaceEnginesWarpAudio;
        ...
        protected virtual void OnEnginesActivated()
        {
            ...
            if (spaceEnginesWarpAudio != null)
            {
                spaceEnginesWarpAudio.volume = 1;
                spaceEnginesWarpAudio.loop = false;
            }
        }
        ...
        protected void UpdateAudio()
        {
            if (spaceVehicleEngines != null && spaceVehicleEngines.EnginesActivated)
            {
                ...
                if (spaceVehicleEngines.IsWarping)
                {
                    spaceEnginesWarpAudio.PlayOneShot(spaceEnginesWarpAudio.clip);
                }
            }
        }
