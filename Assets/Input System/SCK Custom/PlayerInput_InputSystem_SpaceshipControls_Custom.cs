...
namespace VSX.UniversalVehicleCombat
{
    ...
    /// </summary>
    public class PlayerInput_InputSystem_SpaceshipControls_Custom : VehicleInput
    {
        ...
        protected virtual void MouseSteeringUpdate()
        {
            ...
            {
                screenInputs = mouseDeltaPositionSensitivity * input.SpacefighterControls.MouseDelta.ReadValue<Vector2>();
        ...
        protected override void InputUpdate()
        {
            ...
            if (mouseSteeringInputs.magnitude >= steeringInputs.magnitude)
            {
                steeringInputs = mouseSteeringInputs;
            }
            else
            {
                hudCursor.CenterCursor();
